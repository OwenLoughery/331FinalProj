...
```{r}
#DOUBLE CHECK VISUAL (SO MANY POINTS)
#Visual 1
school_fertility_df |>
...
#OR TO REDUCE # OF POINTS, AVG PER COUNTRY OVER YEAR
school_fertility_df |>
  ...
  geom_smooth(method = "lm")
  labs(x = "Average Mean Years in School", y = "Average Babies per Woman",
...
visual_2 <- school_fertility_df |>
  ...
  ggplot(aes(x = mean_years_in_school, y = babies_per_woman, color = Continent)) +

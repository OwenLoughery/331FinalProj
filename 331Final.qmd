...
simulation <- function(mod){
  pred_num_babies <- predict(mod)
  est_sigma <- sigma(mod)
  x <- length(pred_num_babies)
...
lin_reg <- lm(data = full_data, avg_babies ~ sim_num_babies)
threetwolin_reg <- tidy(lin_reg, conf.int = TRUE)
print(threetwolin_reg)
